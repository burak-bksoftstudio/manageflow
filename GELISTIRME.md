...
| Mevcut sürüm | `0.13.0-project-lifecycle` |
| Mevcut aşama | Proje oluşturma, detay, düzenleme, durum/ilerleme ve güvenli arşivleme Supabase ile çalışıyor |
| Sonraki ana hedef | Projelere gerçek organizasyon üyelerini atama ve proje ekibi yönetimi |
...
| Projeler | Gerçek liste, oluşturma, detay, düzenleme, durum/ilerleme ve arşivleme Supabase ile bağlı |
...
Proje CRUD yaşam döngüsü fiziksel silme yerine geri alınabilir arşivleme kullanılarak tamamlanmıştır. Proje üyeleri sıradaki pakettedir.
...
- Proje üyesi atama ve proje ekibi yönetimi
...
1. Proje ve organizasyon üyesi arasında çoklu ilişki kuran `project_members` veri modelini oluştur.
2. Yalnızca aynı organizasyonun aktif ekip üyelerinin projeye atanabilmesini veritabanında zorunlu kıl.
3. Proje detay drawer'ına proje ekibi bölümü ekle.
4. Owner/admin/proje yöneticisi için üye ekleme ve çıkarma akışını bağla.
5. Member rolüne proje ekibini okuma izni ver; atama değişikliğini reddet.
6. Çapraz organizasyon üye ataması, tekrar eden atama ve arşivlenmiş proje davranışını doğrula.

Sıradaki ManageFlow geliştirme paketinin başarı ölçütü:

```text
Yetkili kullanıcı proje detayında aktif ekip üyelerini görebilir
→ Bir veya daha fazla üyeyi projeye atayabilir
→ Aynı üye aynı projeye iki kez atanamaz
→ Atamalar sayfa yenilemesinde korunur
→ Member proje ekibini görür fakat değiştiremez
→ Başka organizasyonun üyesi projeye atanamaz
```
