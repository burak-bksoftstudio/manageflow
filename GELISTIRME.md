...
| Mevcut sürüm | `0.25.1-custom-domain` |
| Mevcut aşama | `manageflow.bksoftstudio.com` özel domaini HTTPS ve production origin ayarlarıyla aktif |
| Sonraki ana hedef | Özel domainde Auth callback smoke testini tamamlayıp güvenli dosya modülüne başlamak |
...
- Özel domainde production şifre yenileme, kayıt doğrulama ve davet kabul callback'lerinin canlı hesaplarla smoke testi
- Google ile giriş
...
- Şifre yenileme, kayıt doğrulama ve davet kabul e-postaları özel domain callback'leriyle ayrıca kullanıcı smoke testinden geçirilmelidir.
