...
1. Ekip timesheet production owner/member kabul testi
2. CSV dışa aktarma ve proje zaman raporları
3. Merkezi Arşiv görünümü
4. Çalışma Alanı not sabitleme, etiket ve arşivleme
5. Supabase Storage tabanlı Dosyalar modülü
6. Gerçek uygulama içi bildirimler
7. Takvim ve toplantı temeli
8. Kanallar ve mesajlaşma
9. Sunucu tarafı Flow AI
10. Planlar, abonelik ve ödeme sistemi
