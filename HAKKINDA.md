...
1. Merkezi Arşiv görünümü
2. Çalışma Alanı not sabitleme, etiket ve arşivleme
3. Supabase Storage tabanlı Dosyalar modülü
4. Gerçek uygulama içi bildirimler
5. Takvim ve toplantı temeli
6. Kanallar ve mesajlaşma
7. Sunucu tarafı Flow AI
8. Planlar, abonelik ve ödeme sistemi
