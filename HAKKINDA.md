...
- Organizasyon değiştirici henüz çalışmıyor
- Google ile giriş yok
- Production SMTP yok
- Zaman kayıtlarında düzeltme/arşivleme yok
- Ekip timesheet'i ve raporlama yok
...
Landing page geliştirilirken `/` herkese açık ürün sayfası olmalı; oturum açmış kullanıcı uygulamaya `Uygulamayı aç` CTA'sı veya `/dashboard` üzerinden girmelidir.
...
Yeni landing page de aynı marka dilini sürdürmeli ancak uygulama shell'inden bağımsız, herkese açık bir pazarlama deneyimi olmalıdır.
...
18. Herkese açık landing page — sıradaki ana çalışma
...
1. Herkese açık SaaS landing page
2. Zaman Takibi v1.1 production kabulü
3. Çalışma Alanı v1 production kabulü
4. Zaman kayıtlarını güvenli düzeltme/arşivleme
5. Owner/admin için ekip timesheet ekranı
6. CSV dışa aktarma ve proje zaman raporları
7. Çalışma Alanı not sabitleme, etiket ve arşivleme
8. Supabase Storage tabanlı Dosyalar modülü
9. Gerçek uygulama içi bildirimler
10. Takvim ve toplantı temeli
11. Kanallar ve mesajlaşma
12. Sunucu tarafı Flow AI
13. Planlar, abonelik ve ödeme sistemi
